      ...
      .then(function (cacheNames) {
        return Promise.all(
          cacheNames.map(function (cacheName) {
            ...
            if (
              (cacheName.startsWith('info-bencana-aceh-') ||
...
self.addEventListener('push', function (event) {
  if (event.data) {
    ...
    const options = {
      body: data.body || 'Notifikasi baru dari Info Bencana Aceh',
    ...
    event.waitUntil(self.registration.showNotification(data.title || 'Info Bencana Aceh', options));
  }
});
